...
public class TextEditorExample extends JFrame implements ActionListener {
	...
	public JToolBar createJTolBar() {
		...
		load.addActionListener(this);
		load.setIcon(new ImageIcon(loadImage("src/main/resources/icons/open.png")));
		toolBar.add(load);
		...
		save.setIcon(new ImageIcon(loadImage("src/main/resources/icons/save.png")));
		toolBar.add(save);

		toolBar.add(createButton("Clear Text", (ae) -> textArea.setText(""), "clear.png"));

		return toolBar;
	}
	
	private JButton createButton(String toolTip, ActionListener al, String iconName) {
		JButton b = new JButton();
 		b.setToolTipText(toolTip);
		b.addActionListener(al);
		b.setIcon(new ImageIcon(loadImage("src/main/resources/icons/"+iconName)));
		return b;
	}
